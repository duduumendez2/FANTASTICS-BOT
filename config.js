...
//========================= [ BOT SETTINGS ] ======8===================\\
global.style = process.env.STYLE   || Math.floor(Math.random()*250) || '0'  // put '1' to "5" here to check bot styles
...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "255711569632";
